...
console.log('Task 1: Name of the first artist - ', artists[0].name);
console.log('Task 1: Bio of the third artist - ', artists[2].bio);
...
function diedIn20s(arr, num) {
  return arr[num].years.substring(0,4) >= 1900 && arr[num].years.substring(7,10) <= 2000;
}

console.log('Task 4 check: ', diedIn20s(artists, 19));
console.log('Task 4 check: ', diedIn20s(artists, 17));
...
console.log('Task 6: ', addArtist(artists, 20, 'Elijah Kim', '1998 - 2020', 'Web Design', 'South Korean', 
            'I am doing this for the sprint. This is my two sentences'));
